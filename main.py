...
def spotify_api_grabber(sp):
    ...
    while running:
        try:
            ...
            if current and current['item'] and current['device']['name'] == "Salon":
                ...
                with lock:
                    ...
                    if shared_song_info["playing"] == True and duration_ms - progress_ms < 1000:
